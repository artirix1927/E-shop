...
class AdminQueries(graphene.ObjectType):
    ...
    model_instances = graphene.Field(gql_types.ModelInstanceType, app_name=graphene.String(), model_name=graphene.String())

    model_instance_form = graphene.Field(gql_types.ModelInstanceFormType, app_name=graphene.String(), model_name=graphene.String(), id=graphene.Int())
    
    model_create_form = graphene.Field(gql_types.ModelCreateFormType, app_name=graphene.String(), model_name=graphene.String() )
    ...
    def resolve_all_apps(self, info):
        ...
        return [gql_types.AppType(funcs.get_app_name_without_dots(app.name)) for app in app_configs]
    ...
    def resolve_model_instances(self, info, app_name, model_name):
        ...
        return gql_types.ModelInstanceType(model_name=model_name, instances=instances_repr_for_type)
    ...
    def resolve_model_instance_form(self, info, app_name, model_name, id):
        ...
        return gql_types.ModelInstanceFormType(app_name=app_name,model_name=model_name, instance_id=id, form=json_form)
    ...
    def resolve_model_create_form(self, info, app_name, model_name):
        ...
        return gql_types.ModelCreateFormType(app_name=app_name, model_name=model_name, form=json_form)
