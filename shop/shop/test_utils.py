...
def create_product_examples() -> tuple[Product, Product]:
   try:
      ...
      prodcut_data =  {"name": "Iphone 15", "price":2999.00, "pieces_left":1, 
                        "description":"Basically 13 iphone but more expensive!", 
                        "category":category, "weight":1.1}
      
      first_product = Product(**prodcut_data)

      category = Category.objects.create(name="Accessories", shortname="accssrs")
      prodcut_data = {"name": "Iphone 15 case", "price":49.99, "pieces_left":5, 
                        "description":"Cool phone case", 
                        "category":category, "weight":0.1}
