...
class GqlQueriesAndMutationCollector():
    ...
    def collect_and_process_files(self) -> None:
        apps_to_look_in = [
            app for app in apps.get_app_configs() if not self.is_installed_package(app)]
    ...
    def process_app_files(self, app: AppConfig) -> None:
        ...
        files_present_in_gql_folder = set(
            gql_folder_contents).intersection(set(self.files_to_look_in))
